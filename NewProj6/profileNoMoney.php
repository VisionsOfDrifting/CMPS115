...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:43px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="updateBudget.php">UpdateBudget</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <?php include 'css/css.html'; ?>
	  ...
	  <div class="form">
          ...
          <h1><?php echo  " $name-$tr_name-$tr_type-$tr_cost-$total-$date." ?></h1>
          <h1><?php echo  " You do not have enough money. Please update your account" ?></h1>
    </div>
