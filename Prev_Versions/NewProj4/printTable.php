...
class TableRows extends RecursiveIteratorIterator { 
    ...
    function current() {
        return "<td style='width:3600px;border:1px solid white;'>" . parent::current(). "</td>";
    }
...
try {
    ...
    $stmt = $conn->prepare("SELECT tr_name, tr_type, tr_cost, date FROM budget WHERE name = '$temp'"); 
    $stmt->execute();
