...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:43px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="insertTransaction.php">Update the Budget</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <?php include 'css/css.html'; ?>
      ...
      <div class="tab-content">
         ...
         <div id="login">   
          <h1>Update the Budget!</h1>
          
          <form action="updateBudgetTrans.php" method="post" autocomplete="off">
          
            <div class="field-wrap">
            <label>
              New Value $<span class="req">*</span>
            </label>
